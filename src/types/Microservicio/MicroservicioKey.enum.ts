 ...
 * Los valores deben coincidir con ServicioEnum.enum.ts (columna servicio.name en la BD).
 *
 * Al agregar uno nuevo:
 *  1. Añadir el valor aquí y en ServicioEnum.enum.ts con el mismo string.
